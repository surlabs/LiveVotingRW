...
use ILIAS\UI\Implementation\Component\Input\Field\HasMustacheVariablesInternal;
 ...
 * Class TextareaRTE
 */
class TextareaRTE extends Input implements Textarea, HasMustacheVariablesInternal {
